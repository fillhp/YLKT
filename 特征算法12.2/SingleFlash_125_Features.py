...
# 计算所有特征
def all_features(row, is_pure1=True, is_pure2=True, max_pure_num=10, exception_threshold=0.5, is_smooth=True, is_round=True, start=20, end=101, is_goone=True, is_pure3=True):
