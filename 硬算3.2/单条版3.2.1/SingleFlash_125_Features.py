...
# 计算所有特征
def all_features(row, is_pure1=True, is_pure2=True, is_smooth=True, is_round=True, start=20, end=101, is_normalization=True,is_pure3=True):
