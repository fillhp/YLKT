...
class testSTLFModel(TestCase):
    ...
    # pyre-fixme[56]
    @parameterized.expand([("godiegxy", m) for m in METHODS])
    ...
    @parameterized.expand(
        [("godiegxy", m, "additive") for m in METHODS]
        + [("godiegxy", m, "multiplicative") for m in METHODS]
    )
