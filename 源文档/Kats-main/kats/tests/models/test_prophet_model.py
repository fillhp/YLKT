...
class ProphetModelTest(TestCase):
    ...
    def test_fbprophet_not_installed(self) -> None:
        ...
        ProphetModel(TEST_DATA["godiegxy"]["ts"], ProphetParams())
    ...
    @parameterized.expand(
        [
            ...
            [
                "godiegxy, cap and floor",
                TEST_DATA["godiegxy"]["ts"],
                TEST_DATA["godiegxy"]["params_cap_and_floor"],
                30,
                False,
                "D",
                None,
            ...
            [
                "godiegxy, logistic with cap",
                TEST_DATA["godiegxy"]["ts"],
                TEST_DATA["godiegxy"]["params_logistic_cap"],
                30,
                False,
                "D",
                None,
            ...
            [
                "godiegxy, custom seasonality",
                TEST_DATA["godiegxy"]["ts"],
                TEST_DATA["godiegxy"]["params_custom_seasonality"],
                30,
                False,
                "D",
                None,
    ...
    def test_exec_plot(self) -> None:
        m = ProphetModel(TEST_DATA["godiegxy"]["ts"], TEST_DATA["godiegxy"]["params"])
        m.fit()
    ...
    def test_search_space(self) -> None:
        ...
        tmp_df = TEST_DATA["godiegxy"]["ts"].to_dataframe()
