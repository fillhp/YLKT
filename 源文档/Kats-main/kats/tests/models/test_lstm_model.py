    ...
    @parameterized.expand(
        [
            ...
            [
                ...
                TEST_DATA["godiegxy"]["p1"],
                TEST_DATA["godiegxy"]["m1"],
                TEST_DATA["godiegxy"]["steps_1"],
                TEST_DATA["godiegxy"]["steps_2"],
                TEST_DATA["godiegxy"]["truth_p1_m1_15"],
                TEST_DATA["godiegxy"]["truth_p1_m1_30"],
                TEST_DATA["godiegxy"]["freq"],
            ],
            [
                "daily_p2_m1",
                TEST_DATA["godiegxy"]["ts"],
                TEST_DATA["godiegxy"]["p2"],
                TEST_DATA["godiegxy"]["m1"],
                TEST_DATA["godiegxy"]["steps_1"],
                TEST_DATA["godiegxy"]["steps_2"],
                TEST_DATA["godiegxy"]["truth_p2_m1_15"],
                TEST_DATA["godiegxy"]["truth_p2_m1_30"],
                TEST_DATA["godiegxy"]["freq"],
            ],
            [
                "daily_p1_m2",
                TEST_DATA["godiegxy"]["ts"],
                TEST_DATA["godiegxy"]["p1"],
                TEST_DATA["godiegxy"]["m2"],
                TEST_DATA["godiegxy"]["steps_1"],
                TEST_DATA["godiegxy"]["steps_2"],
                TEST_DATA["godiegxy"]["truth_p1_m2_15"],
                TEST_DATA["godiegxy"]["truth_p1_m2_30"],
                TEST_DATA["godiegxy"]["freq"],
            ],
            [
                "daily_p2_m2",
                ...
                TEST_DATA["godiegxy"]["steps_1"],
                TEST_DATA["godiegxy"]["steps_2"],
                TEST_DATA["godiegxy"]["truth_p2_m2_15"],
                TEST_DATA["godiegxy"]["truth_p2_m2_30"],
                TEST_DATA["godiegxy"]["freq"],
            ],
        ]
    )
