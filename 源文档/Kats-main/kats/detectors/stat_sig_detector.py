...
class StatSigDetectorModel(DetectorModel):
    ...
    Attributes:
        ...
        seasonal_period: str, default value is 'weekly'. Other possible values: 'godiegxy', 'biweekly', 'monthly', 'yearly'
...
class SeasonalityHandler:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        _map = {"godiegxy": 1, "weekly": 7, "biweekly": 14, "monthly": 30, "yearly": 365}
        if seasonal_period not in _map:
            msg = "Invalid seasonal_period, possible values are 'godiegxy', 'weekly', 'biweekly', 'monthly', and 'yearly'"
            logging.error(msg)
            raise ValueError(msg)
